...
# Adapted by Eleanor Bacon to include quadratic_quad and quadratic_hexahedron
__license__ = "New BSD"
...
class UnstructuredGrid(DataSet.DataSet):
    ...
    Usage:
      UnstructuredGrid(<sequence of 3-tuples of points>,
                       ...
                       quadratic_quad = <sequence of XXX-sequences>
                       quadratic_tetra = <sequence of 10-sequences>
                       quadratic_hexahedron = <sequence of XXX-sequences>
                       )
    Attributes:
      points
      vertex
      ...
      quadratic_quad, quadratic_tetra, quadratic_hexahedron
    Public methods:
      get_size()
      get_cell_size()
    ...
    _vtk_cell_types_map = {'vertex':1,'poly_vertex':2,'line':3,'poly_line':4,
                           ...
                           'wedge':13,'pyramid':14,'quadratic_quad':23,
                           'quadratic_tetra':24, 'quadratic_hexahedron':25}
    _vtk_cell_nums_map = {'vertex':1,'poly_vertex':-1,'line':2,'poly_line':-1,
                          ...
                          'wedge':6,'pyramid':5,'quadratic_quad':8,
                          'quadratic_tetra':10,'quadratic_hexahedron':20}
    _vtk_cell_types_imap = {1:'vertex',2:'poly_vertex',3:'line',4:'poly_line',
                            ...
                            13:'wedge',14:'pyramid',23:'quadratic_quad',
                            24:'quadratic_tetra',25:'quadratic_hexahedron'}
